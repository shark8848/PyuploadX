...
const ZH: Messages = {
  ...
  "queue.resume": "继续",
  "queue.reselect": "重新选择",
  "queue.reselectDone": "已选择 {name}，继续上传",
  "queue.reselectCancelled": "未选择文件，已取消",
  "queue.errObjectExists": "同名对象已存在：{path}",
  "queue.retry": "重试",
  "queue.cancel": "取消",
  "queue.download": "下载",
  "queue.history": "已完成历史",
...
const EN: Messages = {
  ...
  "queue.reselectDone": "Selected {name}, resuming upload",
  "queue.reselectCancelled": "No file selected, cancelled",
  "queue.errObjectExists": "An object with the same name already exists: {path}",
  "queue.retry": "Retry",
  "queue.cancel": "Cancel",
