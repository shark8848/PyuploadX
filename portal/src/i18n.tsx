...
const ZH: Messages = {
  ...
  "tree.deleteBucket": "删除桶",
  "bucket.deleteTitle": "删除桶",
  "bucket.deleteConfirm": "你确定要删除 {name} bucket？",
  "bucket.deleteHint": "此操作不可撤销。请输入桶名 {name} 以确认删除。",
  "bucket.deletePlaceholder": "请输入桶名",
  "bucket.deleted": "桶 {name} 已删除",
  "bucket.notEmpty": "桶 {name} 非空，无法删除",
  "bucket.notDeletable": "桶 {name} 为系统配置桶，不允许删除",
  "bucket.notFound": "桶 {name} 不存在",
  "bucket.deleteFailed": "删除失败：{msg}",
...
const EN: Messages = {
  ...
  "tree.deleteBucket": "Delete bucket",
  "bucket.deleteTitle": "Delete bucket",
  "bucket.deleteConfirm": "Are you sure you want to delete bucket {name}?",
  "bucket.deleteHint": "This action cannot be undone. Type the bucket name {name} to confirm.",
  "bucket.deletePlaceholder": "Enter the bucket name",
  "bucket.deleted": "Bucket {name} deleted",
  "bucket.notEmpty": "Bucket {name} is not empty and cannot be deleted",
  "bucket.notDeletable": "Bucket {name} is a configured bucket and cannot be deleted",
  "bucket.notFound": "Bucket {name} does not exist",
  "bucket.deleteFailed": "Delete failed: {msg}",
